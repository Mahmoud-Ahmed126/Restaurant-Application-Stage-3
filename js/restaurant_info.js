...
fillReviewsHTML = (reviews) => {
  ...
  more.innerHTML = 'Add Review';
  more.href = DBHelper.urlForAddReview();
  more.setAttribute("aria-label", "Add New Review for restaurant");
  more.setAttribute("class", "add-review");
...
function addReview() {
  ...
  window.location = "http://localhost:8000/restaurant.html?id=" + res_id;
}
